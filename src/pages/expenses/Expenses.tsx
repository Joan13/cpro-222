                ...
                <View style={{ paddingBottom: 20, paddingHorizontal: 20 }}>
                    ...
                    <View style={{
                        ...
                        <View style={{ gap: 6 }}>
                            ...
                            {/* List Categories */}
                            {(show_all_categories ? (strings.expenses_categories || []) : (strings.expenses_categories || []).slice(0, 4)).map((catItem: any) => {
                                const isSelected = category_filter === catItem.id;
                                const categoryColor = theme.high_color;
                            ...
                            {(strings.expenses_categories || []).length > 4 && (
                                <Pressable
                                    ...
                                    <TextSmallYambi text={show_all_categories ? (strings as any).see_less || "See less" : `${(strings as any).view_all || "View all"} (${(strings.expenses_categories || []).length})`} styles={{ color: theme.high_color }} />
                                </Pressable>
                            )}
                        </View>
                    </View>
