                    ...
                    {showBusinesses ? (
                        ...
                        >
                            <View style={{ paddingBottom: 10, paddingHorizontal: 20 }}>
                                ...
                                {accessibleBusinesses.map((b: any) => {
                        ...
                        >
                            <View style={{ paddingBottom: 10, paddingHorizontal: 20 }}>
                                ...
                                {salesPoints.map((sp: any) => {
                                    ...
                                    const business = accessibleBusinesses.find((b: any) => b._id === sp.business_id);
                                    return (
                                        <Pressable
                                            key={sp._id}
                                            onPress={() => {
                        ...
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginBottom: 15 }}>
                            ...
                            >
                                <YambiText
                                    ...
                                    style={{ color: payment_type === 1 ? theme.button_foreground_color : theme.text, fontSize: 14 }} color="design"
                                />
                            </Pressable>
                            <Pressable
                            ...
                            >
                                <YambiText
                                    ...
                                    style={{ color: payment_type === 2 ? theme.button_foreground_color : theme.text, fontSize: 14 }} color="design"
                                />
                            </Pressable>
                            <Pressable
                            ...
                            >
                                <YambiText
                                    ...
                                    style={{ color: payment_type === 3 ? theme.button_foreground_color : theme.text, fontSize: 14 }} color="design"
                                    numberLines={1}
                                />
                            </Pressable>
                        </View>
