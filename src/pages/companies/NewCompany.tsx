...
const NewCompany = () => {
    ...
    const NewBusiness = () => {
        ...
        if (name === "" || category === null || address === "") {
            ...
            // const companyID = randomString(5).toUpperCase() + renderDateUpToMilliseconds();
            ...
            axios.post(remote_host + "/yambi/API/new_company", { company: company })
                .then(json => {
                    const cc = json.data.company;
