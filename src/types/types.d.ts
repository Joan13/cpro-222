...
export type RootStackParamList = {
    ...
    BusinessOverviewGraphs: { business_id: string; sales_point_id: string; item_id: string; date_start?: string; date_end?: string; user_filter?: string; currency_filter?: string; category_filter?: number };
